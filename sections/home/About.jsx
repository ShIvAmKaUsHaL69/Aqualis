...
export default function About() {
  return (
    <div className='bg-[url(/Aboutbackground.png)] min-h-[100vh] flex items-center bg-no-repeat bg-cover pt-10 lg:pt-28' id='about'>
      ...
      <div className="block lg:flex flex-row w-full gap-80">
        ...
        <div className="flex w-full lg:w-1/2 lg:mt-0 mt-10 flex-col gap-5">
