...
export default function About() {
  return (
    <div className='bg-[url(/Aboutbackground.png)] bg-center min-h-[100vh] flex items-center bg-no-repeat bg-cover pt-10 lg:pt-0' id='about'>
      <div className='lg:px-[13.5%] mx-auto w-full flex flex-col items-start gap-3 px-5'>
      <div className="block lg:flex flex-row w-full pt-20 gap-20">
        <div className="relative w-full lg:w-[60%]">
            <img src="/aboutusbgimg.png" alt='shipsailing' className="w-full h-full" />
        </div>
        <div className="flex w-full lg:w-1/2 lg:mt-0 mt-10 flex-col gap-5 xxl:gap-10 pl-[1%] xxl:pl-[4%]">
