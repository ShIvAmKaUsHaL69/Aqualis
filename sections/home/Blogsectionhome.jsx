    ...
    <div className='lg:px-[13.5%] mx-auto w-full px-4'>
      ...
      <div className='flex mt-10 flex-col lg:flex-row gap-7'>
            ...
            <div className='lg:w-1/2 w-full gap-10 lg:gap-0 flex lg:flex-col flex-col md:flex-row justify-between'>
                <Link href={`/blogs/${rows[2].id}`} className='bg-[#F1F1F1] rounded-lg' passHref><Homeblogcard title={rows[2].title} imge={rows[2].image_url} description={rows[2].shortdesc}/></Link>
                
                <Link href={`/blogs/${rows[1].id}`} passHref className='bg-[#F1F1F1] rounded-lg'><Homeblogcard title={rows[1].title} imge={rows[1].image_url} description={rows[1].shortdesc}/></Link>
            </div>
      </div>
    </div>
  </div>
