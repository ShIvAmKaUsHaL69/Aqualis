...
export default function Entry() {
  return (
    <div className='min-h-[100vh] overflow-hidden relative w-full flex items-end pb-8'>       
        <Videobg />
      <div className='lg:px-[13.5%] mx-auto w-full flex flex-col items-start gap-3 px-5 relative z-10'>
