  ...
  return (
    <div>
      <div className='bg-[url(/footerbackgroundimage.jpg)] bg-bottom bg-cover h-96 '>
        ...
        <div className='lg:px-[13.5%] mx-auto w-full h-full px-7 py-14 flex items-end lg:justify-end justify-center'>
            <form className='border-white border-0 lg:border-2 rounded-lg flex flex-col gap-2 lg:gap-0 lg:flex-row'>
                <input className='bg-transparent border-2 lg:border-0 rounded-lg text-sm lg:text-xs xxl:text-sm placeholder:text-white placeholder:text-sm lg:placeholder:text-xs xxl:placeholder:text-sm py-2 text-white px-3 lg:w-[13rem] xl:w-[20rem] w-full' type='email' name='email' placeholder='Email here*'/>
                <button aria-label="newsletter button" type='submit' href='#' className='bg-[#05363b] text-sm lg:text-xs xxl:text-sm text-white py-3 px-5 border-0 lg:border-l-2 rounded-r-lg'>Subscribe To News And Update</button>
            </form>
        </div>
        </div>
      </div>
      <div className='bg-[#1E7179]'>
        <div className='lg:px-[13.5%] mx-auto w-full h-full px-5 py-20 flex flex-col gap-10 lg:gap-0 lg:flex-row xl:justify-between sm:justify-around'>
          <div>
          ...
          <div className='flex flex-col lg:flex-row gap-10 lg:gap-4 xl:gap-20 xxl:gap-48'>
            <div className=''>
      ...
      <div className='bg-[#1E7179] relative'>
        <div className='lg:px-[13.5%] mx-auto w-full h-full px-5 py-10 text-xs text-white'>
