  ...
  return (
    <div>
      <div className='bg-[url(/footerbackgroundimage.jpg)] bg-bottom bg-cover h-96  '>
        ...
        <div className='lg:px-[8%] mx-auto w-full h-full px-5 py-5 flex items-end lg:justify-end justify-center'>
      ...
      <div className='bg-[#1E7179]'>
        <div className='lg:px-[8%] mx-auto w-full h-full px-5 py-20 flex flex-col gap-10 lg:gap-0 lg:flex-row xl:justify-between sm:justify-around'>
          <div>
      ...
      <div className='bg-[#1E7179] relative'>
        <div className='lg:px-[8%] mx-auto w-full h-full px-5 py-10 text-xs text-white'>
