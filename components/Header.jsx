...
export default function Header({ className }) {
  return (
    <div className={`w-full min-h-20 bg-[#FFFFFF66] fixed top-0 z-50 transition-transform duration-300 ${className}`}>
      <div className=" justify-between items-center px-5 flex flex-row lg:px-[13.5%] py-1 xxl:py-2">
        <img src="/logo.png" className="" alt="logo" />
        <div className="hidden lg:flex flex-row xxl:gap-16 gap-5 xl:gap-10 text-xs xxl:text-[15px] text-[#05363B] font-bold">
          <Link href="/">Home</Link>
