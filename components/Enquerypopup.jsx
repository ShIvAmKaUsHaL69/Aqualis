...
export default function Enquerypopup() {
  ...
  return (
    <div className='mt-10'>
    {!Popup ? (
        <button onClick={handlepopup} className='bg-[#05363B] text-white text-xl px-10 py-3 rounded-md'>Send Enquiry</button>
    ) : (
        <div>
        <button onClick={handlepopup} className='bg-[#05363B] text-white text-xl px-10 py-3 rounded-md'>Send Enquiry</button>
        <div className='absolute w-full h-full bg-[#00000024] top-0 left-0'>
        <div className='max-w-[1280px] mx-auto flex items-end justify-end pb-32 lg:pb-48 px-4 lg:px-40 w-full h-full'>
      ...
      <button onClick={handlepopup} className='bg-[#05363B] text-white text-base px-5 py-2 lg:mt-4 mt-2 rounded-md'>Okay</button>
      </div>
      </div>
    </div>
    </div>
